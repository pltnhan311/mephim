...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, navItems, userMenuItems }) => {
  ...
  return (
    <motion.div
      ...
      className='fixed top-0 left-0 h-full w-72 bg-container/95 shadow-lg z-[61] overflow-y-auto'
    >
      <div className='p-6'>
