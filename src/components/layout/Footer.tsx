...
const Footer = () => {
  return (
    <footer className='bg-container text-gray-300 border-t border-gray-800'>
      <div className='container mx-auto px-4 py-8 md:py-8'>
        <div className='flex items-center justify-center gap-8'>
          <div className=''>
            <NavLink to='/' className='inline-block'>
              <img src='/netflix-logo.png' alt='Mephim Logo' className='w-20 h-20 md:w-24 md:h-24' />
            </NavLink>
          </div>
          <div>
            <p className='text-sm text-gray-400 leading-loose'>
              ...
              giây giải trí tuyệt vời cho bạn.
            </p>
          </div>
        </div>
        ...
        <div className='mt-8 pt-8 border-t border-gray-800'>
          <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
            <div className='text-sm text-gray-400'>© 2024 Mephim. All rights reserved.</div>
